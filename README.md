...
1. wilkinson_power_splitter.cst :
...
2. microstrip_to_pad.cst :
  SMA Connector pad has 1.5mm width. However the 50Ohm microstrip line for H = 6.7mil, T = 1.4mil, Er = 3.66 is 0.34mm. There   will be reflection. To prevent this a cutout is simulated. 1.5mm pad is coupled to 3rd layer ground. In this way RL =         -22.9dB meaning that reflected power is 0.5%
